...
class App_KernelTestDebugContainer extends Container
{
    ...
    protected function getTest_PrivateServicesLocatorService()
    {
        return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'enqueue.consumption.signal_extension' => ['privates', 'enqueue.consumption.signal_extension', 'getEnqueue_Consumption_SignalExtensionService', false],
            ...
            'messenger.listener.dispatch_pcntl_signal_listener' => ['privates', 'messenger.listener.dispatch_pcntl_signal_listener', 'getMessenger_Listener_DispatchPcntlSignalListenerService', false],
            ...
            'messenger.listener.stop_worker_on_sigterm_signal_listener' => ['privates', 'messenger.listener.stop_worker_on_sigterm_signal_listener', 'getMessenger_Listener_StopWorkerOnSigtermSignalListenerService', false],
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('khNaWWT3+U', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ykqVpmTZth', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('80IcLqwiDr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4FNdtWpq4B', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Sn2WQlQp51', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('trXsNlgBvX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q8bFq1llP-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    /**
     * Gets the private 'enqueue.consumption.signal_extension' shared service.
     *
     * @return \Enqueue\Consumption\Extension\SignalExtension
     */
    protected function getEnqueue_Consumption_SignalExtensionService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/enqueue/enqueue/Consumption/StartExtensionInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/enqueue/enqueue/Consumption/PreConsumeExtensionInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/enqueue/enqueue/Consumption/PostMessageReceivedExtensionInterface.php';
        ...
        return $this->privates['enqueue.consumption.signal_extension'] = new \Enqueue\Consumption\Extension\SignalExtension();
    }
    ...
    protected function getEnqueue_Transport_Default_ConsumptionExtensionsService()
    {
        ...
        return $this->privates['enqueue.transport.default.consumption_extensions'] = new \Enqueue\Consumption\ChainExtension([0 => ($this->privates['enqueue.consumption.signal_extension'] ?? ($this->privates['enqueue.consumption.signal_extension'] = new \Enqueue\Consumption\Extension\SignalExtension())), 1 => ($this->privates['enqueue.consumption.reply_extension'] ?? ($this->privates['enqueue.consumption.reply_extension'] = new \Enqueue\Consumption\Extension\ReplyExtension())), 2 => ($this->privates['enqueue.transport.default.log_extension'] ?? ($this->privates['enqueue.transport.default.log_extension'] = new \Enqueue\Consumption\Extension\LogExtension()))]);
    }
     ...
     */
    protected function getMessenger_Listener_DispatchPcntlSignalListenerService()
    {
    ...
    protected function getMessenger_Listener_StopWorkerOnSigtermSignalListenerService()
    {
        ...
        return $this->privates['messenger.listener.stop_worker_on_sigterm_signal_listener'] = new \Symfony\Component\Messenger\EventListener\StopWorkerOnSigtermSignalListener();
    }
