...
class __TwigTemplate_b2e11e76209066873cda2655783b8f8bd4ef35cee0104e1fd7f2bb6acc4550ba extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 5
        $this->loadTemplate("article/_form.html.twig", "article/update.html.twig", 5)->display(twig_array_merge($context, ["form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 5, $this->source); })())]));
        // line 6
        echo "    <button>Modifier un article</button>
    ";
        // line 7
...
{% block body %}
    ...
    {{ form_end(form) }}
{% endblock %}
", "article/update.html.twig", "E:\\Documents\\Sites\\SDS-CLEAN\\templates\\article\\update.html.twig");
    }
}
